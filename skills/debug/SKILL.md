...
5. **Trace Data Flow**
   ...
   **WHEN error is deep in call stack:**
   ...
   See `skills/debug/root-cause-tracing.md` for the complete backward tracing technique.
...
1. **Create Failing Test Case**
   ...
   - Use the `sp-compound:flexible-tdd` skill for writing proper failing tests
...
- **`skills/debug/root-cause-tracing.md`** - Trace bugs backward through call stack to find original trigger
- **`skills/debug/defense-in-depth.md`** - Add validation at multiple layers after finding root cause
- **`skills/debug/condition-based-waiting.md`** - Replace arbitrary timeouts with condition polling

**Related skills:**
- **sp-compound:flexible-tdd** - For creating failing test case (Phase 4, Step 1)
- **sp-compound:verification** - Verify fix worked before claiming success
...
**Called by:**
- Directly by user when encountering bugs or test failures
- Suggested by `sp-compound:work` when implementer reports BLOCKED due to test failure

**Invokes:**
- **sp-compound:flexible-tdd** — for creating failing test case (Phase 4)
- **sp-compound:verification** — for verifying fix (Phase 4)
- **sp-compound:compound** — suggest capturing the learning after fix
