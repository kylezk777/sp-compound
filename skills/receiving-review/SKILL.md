...
### From External Reviewers (PR comments, CI bots)
```
BEFORE implementing:
...
**Called by:**
- Directly by user when handling code review feedback
- After `sp-compound:finishing-branch` creates a PR and feedback arrives

**Related:**
- **sp-compound:review** — the opposite direction: review GENERATES feedback, this skill HANDLES feedback
- **sp-compound:verification** — verify fixes before claiming them done
