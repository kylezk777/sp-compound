...
Task tool (general-purpose):
  ...
  prompt: |
    ...
    **Ask them now.** Raise any concerns before starting work.
    ...
    2. Write tests (following the execution note's TDD strategy)
    ...
    **Testing:** Tests verify behavior? TDD followed per execution note? Comprehensive?

    If issues found during self-review, fix them now.
